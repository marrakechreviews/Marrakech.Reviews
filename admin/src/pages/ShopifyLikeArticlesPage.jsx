...
import ShopifyLikeEditor from '../components/ShopifyLikeEditor';
import SeoTools from '../components/SeoTools';

const ShopifyLikeArticlesPage = () => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      if (formData.content.trim().length < 10) {
        ...
        toast.error('Article content must be at least 10 characters long');
        return;
      }
  ...
  const ArticleDialog = ({ isOpen, onClose, title }) => (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={`${isFullscreenEditor ? 'max-w-full max-h-full w-screen h-screen' : 'max-w-6xl max-h-[90vh]'} overflow-hidden`}>
        <DialogHeader className={isFullscreenEditor ? 'hidden' : ''}>
        ...
        <div className={`${isFullscreenEditor ? 'h-full' : 'max-h-[80vh]'} overflow-hidden`}>
          {isFullscreenEditor ? (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Shopify-Style Articles
          </h1>
          <p className="text-gray-600">Create and manage articles with advanced block-based editing</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-700">Drafts</p>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                {searchTerm || categoryFilter !== 'all' || statusFilter !== 'all'
                  ...
                  : 'Get started by creating your first article with our Shopify-style editor.'}
              </p>
...
export default ShopifyLikeArticlesPage;
