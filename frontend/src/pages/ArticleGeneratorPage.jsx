  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Generate SEO-optimized articles from any URL using AI. Create professional, ready-to-publish content automatically." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            Simply enter the URLs and let AI create professional content for you.
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Add the URLs of websites you want to convert into articles. Our AI will analyze the content and create SEO-optimized articles.
            </CardDescription>
          </CardHeader>
        ...
        {articles.length > 0 && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Generated Articles</h2>
                    ...
                    <div>
                      ...
                      {article.scraped_data && (
                        <CardDescription className="mt-2">
                          <strong>Title:</strong> {article.scraped_data.title}<br />
                          <strong>Description:</strong> {article.scraped_data.description}
                        </CardDescription>
                      )}
                    </div>
                    <div className="flex gap-2">
                  ...
                  <CardContent>
                    <div className="flex gap-2 mb-4">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => downloadHtml(article.html_content, article.url)}
                        className="flex items-center gap-2"
                      >
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => copyToClipboard(article.html_content, index)}
                        className="flex items-center gap-2"
                      >
                        {copiedIndex === index ? (
